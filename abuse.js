...
// ─── Outbound pause (transient — used by the PAUSE_OUTBOUND/RESUME_OUTBOUND
//     control-plane commands, distinct from the persistent kill switch) ────────

let outboundPaused = false

export function setOutboundPaused(value) {
  outboundPaused = Boolean(value)
}
